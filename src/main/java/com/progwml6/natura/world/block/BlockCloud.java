...
public class BlockCloud extends EnumBlock<BlockCloud.CloudType>
{
    ...
    public BlockCloud()
    {
        super(NaturaWorld.cloud, TYPE, CloudType.class);
    ...
    {
        int meta = this.getMetaFromState(state);
        if (meta == 3 && heldItem.getItem() != null && heldItem.getItem() == Items.FLINT_AND_STEEL)
        {
            worldIn.setBlockToAir(pos);
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        return block != NaturaWorld.cloudBlock && super.shouldSideBeRendered(blockState, blockAccess, pos, side);
    }
